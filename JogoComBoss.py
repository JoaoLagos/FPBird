        ...
        ########Boss##############################
            ...
            if boss == False:
                if len(inimigos)>0:
                    ...
                    inimigos = []
                boss = True
                zeppelin = Sprite("components/sprites/inimigo/zeppelin.png")
                zeppelin.x = janela.width
                zeppelin.y = janela.height/2 - zeppelin.height/2
            else:
                for tiro in tiros:
                    if tiro.collided(zeppelin):
                        VidaBoss -= 1
                        if tiro in tiros:
                            tiros.remove(tiro)
                        if VidaBoss > 0:
                            ...
                            pontos += 5
                if zeppelin.x > 800:
                    zeppelin.x -= 100 * janela.delta_time()
                zeppelin.draw()
        #################################################
