    ...
    while len(vidas) > 0:
        ...
        for boost in boostsAtivos:
            ...
            if boost[0].collided(passaro):
                ...
                '''
                if boost[1] == bArmor[
                    0] and reloadInvencivel <= 0:  # ARMOR ### Tem que colocar reloadInvencivel<=0 para as vezes não bugar, pq se colidir com o bullet inimigo e dps pegar armor, o sprite fica travado no FlyAnimation_Armor.png
                    xAux = passaro.x
                    yAux = passaro.y
